...
export default function App() {
  ...
  const [notificationMessage, setNotificationMessage] = useState<Notification | null>(null);
  ...
  return (
    <View style={{display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
      ...
      <Text>{location && notificationMessage?.data?.latitude && notificationMessage?.data?.longitude ? haversine(notificationMessage?.data?.latitude, notificationMessage?.data?.longitude, location?.coords.latitude, location?.coords.longitude) : '...'}</Text>
    </View>
  );
}
